...
INSERT INTO
  `s4u3u_categorybrandslink` (`id_brands`, `id_categories`)
VALUES
  (38, 22),
  (39, 22),
  (40, 22);
...
INSERT INTO
  `s4u3u_pops` (
    ...
    `tags`,
    `reference`,
    `officialPopImageInTheBox`,
    `officialPopImageOutBox`,
    `id_brands`
  )
VALUES
  (
    ...
    125,
    12458,
    'gokuUltraInstint-removebg-preview.png',
    'simpsonItchy.png',
    40
  );
...
VALUES
  (
    ...
    'uploads/OIP.jpg',
    'AledOscourt',
    'julien.fournier2508@gmail.com',
    '$2y$10$ztDbIct3i1MjmvMq9yiLo.otBGFa5oOUzGlYZN8DSmoBAqGhF3zAu',
    '2022-02-04',
    1
  ),
  (
    ...
    NULL,
    'Aled',
    'julien25.fournier08@gmail.com',
    '$2y$10$wrUVPzOw.K/Hq9xQkbc7A.YQGn1j05pjoCl9BAF63j1iqISmoIKeS',
    '2022-02-08',
    2
  ),
  (
    ...
    'uploads/OIP.jpg',
    'Aled-Oscoure',
    'julien25fournier08@gmail.com',
    '$2y$10$raIbWh7MSgYsUMSF7ag2Dup.TC.JYAAAocI/PydsdYzUOEAd/G.F2',
    '2022-02-08',
    2
  ),
  (
    ...
    NULL,
    'Aledo',
    'cuhgsi.dgbjd@dsu.com',
    '$2y$10$lyQqnrv.Taxv79YWREILv.m8rJ4i41YTO7bQxM4iK0OCjv7ZbY3lq',
    '2022-02-11',
    2
  );
