...
<!--**********************************************************************Carousel*********************************************************************** -->
<div id="carouselControls" class="carousel slide carousel-fade my-3" data-bs-touch="true" data-bs-ride="carousel">
            <div class="carousel-inner ">
                <!------------------------------------------------------- Premiere slide du carousel ---------------------------------------------------------------------->
                <div class="carousel-item active text-center firstComingSoon" data-bs-interval="3500">
                    <div class="row align-items-center animate__animated animate__fadeIn animate__slower">
                        <img src="assets/img/gokuUltraInstint-removebg-preview.png" class="col-6 ms-lg-5 ps-5 py-3 py-lg-2 w-50 img-fluid" alt="gokuUltraInstint">
                        <div class="col-3 ms-lg-5 ms-3 text-light animate__animated animate__zoomIn animate__slower">
                            <h2> Coming</h2>
                            <h2>Soon</h2>
                ...
                <div class="carousel-item text-center secondComingSoon" data-bs-interval="3500">
                    <div class="row align-items-center animate__animated animate__fadeIn animate__slower">
                        <img src="assets/img/disneyRapunzel.png" class="col-6 ms-lg-5 ps-5 py-3 py-lg-3 w-50 img-fluid" alt="Disney Rapunzel">
                        <div class="col-3 ms-lg-5 ms-3 text-light animate__animated animate__zoomIn animate__slower">
                            <h2> Coming</h2>
                            <h2>Soon</h2>
                ...
                <div class="carousel-item text-center thirdComingSoon" data-bs-interval="3500">
                    <div class="row align-items-center animate__animated animate__fadeIn animate__slower">
                        <img src="assets/img/simpsonItchy.png" class="col-6 ms-lg-5 ps-5 pt-3 pt-lg-5 py-4 py-lg-4 w-50 img-fluid" alt="Simpson Itchy">
                        <div class="col-3 ms-lg-5 ps-5 ms-3 text-light animate__animated animate__zoomIn animate__slower">
                            <h2> Coming</h2>
                            <h2>Soon</h2>
        ...
        <div class="container selector my-3" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="row" data-aos="fade-up" data-aos-duration="500">
                <a class="d-flex col-md align-items-center text-center selector-left-banner text-decoration-none">
                    <img src="assets/img/disneyRapunzel.png " class="col-7 ms-lg-5 py-2 w-50 img-fluid" alt="Disney Rapunzel ">
                    <div class="col-4 ms-lg-5 ms-3 text-light" data-aos="zoom-in" data-aos-duration="2500">
                        <h2> Coming</h2>
                        <h2>Soon</h2>
                    </div>
                </a>
                <a class="d-flex col-md align-items-center text-center selector-right-banner text-decoration-none">
                    <img src="assets/img/disneyRapunzel.png " class="col-7 ms-lg-5 py-2 w-50 img-fluid" alt="Disney Rapunzel ">
                    <div class="col-4 ms-lg-5 ms-3 text-light" data-aos="zoom-in" data-aos-duration="2500">
                        <h2>Categorie</h2>
                    </div>
        ...
        </div><?php include('assets/template/footerLogIn.php');?>
