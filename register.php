...
<form action="Inscription" method="POST" class="container my-5 d-grid gap-2 logIn">
    ...
    <div class="row mx-lg-5 mx-2 justify-content-around mt-5">
        <a type="button" class="btn btn-outline-secondary col-lg-3 col-5" href="Accueil">Annuler</a>
        <button type="submit" class="btn btn-outline-primary col-lg-3 col-5" name="addUsers">Confirmer</button>
    </div>
